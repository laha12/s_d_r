...
for run in get_tcp_run_list():
    ...
    debug_env = ""
    if run.get("algorithm_label") == "ucb":
        debug_env = (
            "UCB_ROUTE_DEBUG_PATH='../../paper/ns3_experiments_ucb_iridium_66_6/exp3_bandwidthtest/"
            + logs_ns3_dir
            + "/ucb_route_debug.txt' "
        )
    elif run.get("algorithm_label") == "spf":
        debug_env = (
            "SPF_ROUTE_DEBUG_PATH='../../paper/ns3_experiments_ucb_iridium_66_6/exp3_bandwidthtest/"
            + logs_ns3_dir
            + "/spf_route_debug.txt' "
        )
    command = (
        ...
        "./build/scratch/main_satnet/main_satnet "
        "--run_dir='../../paper/ns3_experiments_ucb_iridium_66_6/exp3_bandwidthtest/runs/" + run["name"] + "' "
        "2>&1 | tee '../../paper/ns3_experiments_ucb_iridium_66_6/exp3_bandwidthtest/" + logs_ns3_dir + "/console.txt'\""
    )
