...
# traffic_generation_rates_mbps = [0.01,0.03,0.05,0.08,0.1,0.3,0.5,0.8,1.0,1.2,1.4,1.6,1.8,2.0]
traffic_generation_rates_mbps = [0.05,0.8,1.6]
...
# ucb_reward_weights = "list(0.33,0.33,0.34)" # Uniform
# ucb_reward_weights = "list(1.0,0.0,0.0)" # DelayOnly
# ucb_reward_weights = "list(0.0,1.0,0.0)" # LoadOnly
# ucb_reward_weights = "list(0.0,0.0,1.0)" # DistOnly
# ucb_reward_weights = "list(0.5,0.5,0.0)" # DelayLoad
# ucb_reward_weights = "list(0.5,0.0,0.5)" # DelayDist
# ucb_reward_weights = "list(0.0,0.5,0.5)" # LoadDist
ucb_reward_weights = "list(0.6,0.2,0.2)" # Default
ucb_epsilon1 = "1e-9"
ucb_epsilon2 = "1e-9"
