...
for run in get_tcp_run_list():
    ...
    if run.get("algorithm_label") == "ucb":
        debug_env = (
            "UCB_ROUTE_DEBUG_PATH='../../paper/ns3_experiments_ucb_iridium_66_6/exp1_spfvsucb/"
            + logs_ns3_dir
            + "/ucb_route_debug.txt' "
        )
    elif run.get("algorithm_label") == "spf":
        debug_env = (
            "SPF_ROUTE_DEBUG_PATH='../../paper/ns3_experiments_ucb_iridium_66_6/exp1_spfvsucb/"
            + logs_ns3_dir
            + "/spf_route_debug.txt' "
        )
    command = (
        ...
        "--run_dir='../../paper/ns3_experiments_ucb_iridium_66_6/exp1_spfvsucb/runs/" + run["name"] + "' "
        "2>&1 | tee '../../paper/ns3_experiments_ucb_iridium_66_6/exp1_spfvsucb/" + logs_ns3_dir + "/console.txt'\""
    )
